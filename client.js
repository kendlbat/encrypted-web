...
async function reloadHash() {
    ...
    if (!window.location.hash) {
        document.body.innerHTML = "<p>No page specified. Maybe you are looking for: <a href='create.html'>encrypting your own files</a>, <a href='text.html'>encrypting plain text</a> or <a href='big.html'>decrypting files</a>.</p>";
        return;
    }
